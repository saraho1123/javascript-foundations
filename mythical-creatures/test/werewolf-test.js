...
describe('Werewolf', function() {
  ...
  it('should start off not hungry', function() {
    var werewolf = new Werewolf("Isaac")
  ...
  it('should be able to eat(victim) once hungry', function() {
    var werewolf = new Werewolf("Isaac");
    var victim = new Victim("cheese crackers");

    werewolf.transform();

    assert.equal(werewolf.eat(victim), "Thanks for the cheese crackers, MOM!");
  });
  ...
  it('should not be able to eat a victim while in human form', function() {
    ...
    werewolf.transform(); // Did I actually made this work? I feel uncertain???
    werewolf.transform();

    werewolf.eat(victim);

    assert.equal(werewolf.eat(victim), "Let's go swimming!");
  });
});
